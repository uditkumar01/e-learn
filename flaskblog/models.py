...
class Post(db.Model):
    ...
    pic_1_data = db.Column(db.String(10485759), default = "NO IMAGE")
    pic_2_data = db.Column(db.String(10485759), default = "NO IMAGE")
    pic_3_data = db.Column(db.String(10485759), default = "NO IMAGE")
