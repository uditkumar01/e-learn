...
class User(db.Model,UserMixin):
    ...
    profile_pic_data = db.Column(db.String(10000000000), nullable = False, default = "default_profile_pic")
...
class Post(db.Model):
    ...
    pic_1_data = db.Column(db.String(10000000000), nullable = False, default = "NO IMAGE")
    pic_2_data = db.Column(db.String(10000000000), nullable = False, default = "NO IMAGE")
    pic_3_data = db.Column(db.String(10000000000), nullable = False, default = "NO IMAGE")
